...
use windows::Win32::{
    ...
    UI::{
        ...
        WindowsAndMessaging::{
            DestroyIcon, LoadImageW, SetClassLongPtrW, GCLP_HICON, GCLP_HICONSM, HICON, ICON_BIG,
            ICON_SMALL, ICON_SMALL2, IMAGE_ICON, LR_DEFAULTCOLOR, SM_CXSMICON, WM_SETICON,
        },
    },
};
...
/// Keeps native icon handles alive while Windows uses them for the main window.
